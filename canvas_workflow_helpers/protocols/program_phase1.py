...
class ProgramStage1(ClinicalQualityMeasure):

    class Meta:
        title = 'Stage 1. Pending Review'
        version = '1.0.0'
        description = (
            'Protocol that displays the program phase 1 for a patient '
    ...
    def compute_results(self) -> ProtocolResult:
        ...
        if self.find_program_status("stage1"):
